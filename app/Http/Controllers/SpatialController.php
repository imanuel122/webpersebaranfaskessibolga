    ...
    public function jarakDuaFaskes(Request $request)
    {
        ...
        $hasil = DB::select("
            SELECT
                ...
                ROUND(ST_Distance(a.geom::geography, b.geom::geography)::numeric / 1000, 3) AS jarak_km
